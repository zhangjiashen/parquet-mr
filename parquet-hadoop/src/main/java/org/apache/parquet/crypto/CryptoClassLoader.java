...
public class CryptoClassLoader {
  ...
  public static final String CRYPTO_CELL_MANAGER_FACTORY_CLASS = "parquet.crypto.cell.manager.factory.class";
  ...
  public static boolean cryptoCellManagerFactoryExists(Configuration configuration) {
    return configuration.get(CRYPTO_CELL_MANAGER_FACTORY_CLASS) != null;
  }
